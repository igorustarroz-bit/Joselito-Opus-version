...
/**
 * Módulo Cards / Big Titles — máster Figma 58182:24099. Subtema oscuro.
 *
 * Banda tipográfica decorativa (en Figma "Cards / Big Titles"; antes se llamaba
 * "Cards / Accordion", de ahí el nombre antiguo del módulo). NO es un acordeón: el
 * acordeón real es el módulo `CardsAccordion` (máster 58512:9289).
...
export default function CardsBigTitles({
