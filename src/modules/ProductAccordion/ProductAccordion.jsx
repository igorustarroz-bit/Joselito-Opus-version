 ...
 * Mobile `58512:9288`.
 *
 * OJO de nomenclatura: en Figma este nodo se llama "Cards / Accordion". En el repo
 * ese nombre ya lo ocupa el módulo `CardsAccordion`, que en realidad es la **banda
 * tipográfica** (otro máster). Para no romper nada, este acordeón real se publica como
 * `ProductAccordion`.
 *
